...
<dt><a href="https://github.com/ianb/pageshot"><strong>PageShot</strong></dt>
<dd>An ongoing experiment in sharing and resharing *content* on the web.  What we share now is URLs, pointers, but this doesn't give the sharer much control over what people will experience.  PageShot tries to add that control by giving sharers tools to copy exact experiences, annotate and collect them, summarize and improve on that content.</dd>
